...
k_f = 1/1.6; % Geometrical discontinuity factor. Reciprocal of K_f from Table 8.3 of [1]
...
M_a = 9.91; % Alternating bending moment [Nm]
M_m = 6.68; % Mean bending moment [Nm]
T_a = 44;   % Alternating torsional moment [Nm]
