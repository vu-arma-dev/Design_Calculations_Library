...
%% Main
if ((7/16)<= shaft_diameter <= 1/2)
    key_number = 305;
    width = 3/32;
    length = 5/8;
    height = 0.25;
elseif ((11/16)<= shaft_diameter <= 3/4)
    key_number = 405;
    width = 1/8;
    length = 5/8;
    height = 0.25;
elseif ((13/16)<= shaft_diameter <= 15/16)
    key_number = 506;
    width = 5/32;
    length = 3/4;
    height = 0.312;
elseif (1<= shaft_diameter <= (1+3/16))
    key_number = 608;
    width = 3/16;
    length = 1;
    height = 0.437;
elseif ((1+1/4)<= shaft_diameter <= (1+3/4))
    key_number = 809;
    width = 1/4;
    length = 1+1/8;
    height = 0.484;
elseif ((1+7/8)<= shaft_diameter <= (2+1/2))
    key_number = 1212;
    width = 3/8;
    length = 1+1/2;
    height = 0.641;
